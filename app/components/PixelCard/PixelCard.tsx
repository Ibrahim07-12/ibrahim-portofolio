...
export default function PixelCard({
    ...
    return (
        <div
            ref={containerRef}
            className={`absolute inset-0 w-full h-full overflow-hidden transition-all duration-500 ${className}`}
        ...
        >
            <canvas
            className="absolute inset-0 w-full h-full block z-[1]" // Tambahkan z-[1]
            ref={canvasRef}
        />
        <div className="relative z-[2]"> {/* Wrap children dengan div yang memiliki z-index lebih tinggi */}
            {children}
        </div>
        </div>
    );
